...
export default function OrdersPage() {
  return (
    /* Main wrapper: min-h-screen ensures enough space for vertical scrolling */
    <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 min-h-screen animate-in fade-in duration-500">
      ...
      {/* Container: overflow-x-auto handles table width, while page handles vertical scroll */}
      <div className="bg-white dark:bg-[#1c2127]/50 rounded-[24px] border border-slate-200 dark:border-[#283039] shadow-xl shadow-black/5">
        <div className="p-3 md:p-5 lg:p-6"> 
          ...
          {/* Table wrapper: ensures horizontal scroll for small screens without breaking vertical scroll */}
      ...
      {/* Bottom spacer for mobile accessibility */}
