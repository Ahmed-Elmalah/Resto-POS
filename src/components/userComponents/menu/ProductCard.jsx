...
export default function ProductCard({ item }) {
  ...
  return (
    <div data-aos="zoom-in" data-aos-duration="900">
      <div className="group cursor-pointer flex flex-col bg-white dark:bg-background-dark rounded-xl transition-all duration-300 overflow-hidden shadow-sm hover:shadow-md hover:-translate-y-1 border border-transparent dark:border-[#3a2520]">
        {/* image */}
