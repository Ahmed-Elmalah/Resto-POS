...
export default function ReservationWidget() {
  return (
    <section className="relative z-20 px-4 -mt-16 mb-16">
      <div className="max-w-[1100px] bg-white mx-auto bg-surface-light dark:bg-surface-dark rounded-xl shadow-2xl border border-gray-100 dark:border-white/5 p-6 md:p-8">
