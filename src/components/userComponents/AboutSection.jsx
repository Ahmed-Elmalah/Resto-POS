      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="w-full lg:w-1/2 relative group">
            ...
            >
              <div className="w-full h-full inset-0 bg-primary/10 rounded-3xl transform rotate-3 transition-transform group-hover:rotate-6 duration-500"></div>
            </div>
            ...
            <div
              data-aos="fade-up"
              data-aos-duration="1000"
              className="absolute -bottom-6 -right-6 bg-white dark:bg-[#1e293b] p-6 rounded-2xl shadow-xl border border-gray-100 dark:border-white/5 hidden md:block"
            >
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div data-aos="fade-up-right" data-aos-duration="1000">
              <Link
                to={"/menu"}
                className="bg-primary inline-block hover:bg-red-600 text-white px-8 py-3.5 rounded-full font-bold shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all duration-500 ease-in-out hover:translate-y-1"
              >
                Discover Our Menu
              </Link>
            </div>
